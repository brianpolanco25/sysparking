    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('home') }}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboard">Home</span></a></li>

                <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Administración</span><i data-feather="more-horizontal"></i></li>

                {{-- @can('Usuarios')
                    <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('usuarios.index') }}"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="User">Usuarios</span></a></li>
                @endcan

                @can('Clientes')
                    <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('clientes.index') }}"><i data-feather="users"></i><span class="menu-title text-truncate" data-i18n="User">Clientes</span></a></li>
                @endcan

                @can('Socios')
                    <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('socios.index') }}"><i data-feather='share-2'></i><span class="menu-title text-truncate" data-i18n="User">Socios</span></a></li>
                @endcan

                @can('Roles')
                    <li class=" nav-item"><a class="d-flex align-items-center" href="{{ route('roles.index') }}"><i data-feather='list'></i></i><span class="menu-title text-truncate" data-i18n="User">Roles y permisos</span></a></li>
                @endcan --}}
