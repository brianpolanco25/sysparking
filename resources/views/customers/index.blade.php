                            ...
                            <div class="col-lg-12 col-xl-6 pl-xl-75 pl-0">
                                <div class="dt-action-buttons text-xl-right text-lg-left text-md-right text-left d-flex align-items-center justify-content-lg-end align-items-center flex-sm-nowrap flex-wrap mr-1">
                                    ...
                                    <div class="dt-buttons btn-group flex-wrap">
                                        ...
                                        <a href="{{ route('clientes.create') }}" class="btn add-new btn-primary mt-50" tabindex="0" aria-controls="DataTables_Table_0" type="button" >
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('clientes.edit', $customer->id) }}" >
                                                        <i data-feather="edit-2" class="mr-50"></i>
                                                        <span>Editar</span>
                                                    </a>

                                                    <form method="POST" id="my_form" action="{{route('clientes.destroy', $customer)}}">
                                                        @csrf 
                                                        @method('DELETE')
