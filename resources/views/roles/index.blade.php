            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Lista de roles</h2>
                            ...
                            <div class="col-lg-12 col-xl-6 pl-xl-75 pl-0">
                                <div class="dt-action-buttons text-xl-right text-lg-left text-md-right text-left d-flex align-items-center justify-content-lg-end align-items-center flex-sm-nowrap flex-wrap mr-1">
                                    ...
                                    <div class="dt-buttons btn-group flex-wrap">
                                        ...
                                        <a href="{{ route('roles.create') }}" class="btn add-new btn-primary mt-50" tabindex="0" aria-controls="DataTables_Table_0" type="button" >
                            ...
                            <table class="user-list-table table table-hover ">
                                ...
                                <tbody >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <form method="POST" id="my_form" action="{{route('roles.destroy', $role)}}">
                                                        @csrf 
                                                        @method('DELETE')
                                        ...
                                        <form method="POST" id="my_form" action="{{route('socios.destroy', $role)}}">
                                            @csrf 
                                            @method('DELETE')
                                        </form>
                                    </tr>
